...
<%
	List<Enrollment> res = (List<Enrollment>) request.getAttribute("showFull");
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><%=t.getLevelId()%></td>
									<td><%=t.getDate()%></td>
									<td><a href="/enroll/view?ID=<%=t.getId()%>">View</a><a
										href="/enroll/edit?ID=<%=t.getId()%>">Edit</a><a
										href="/enroll/delete?ID=<%=t.getId()%>">Delete</a></td>
								</tr>
								<%
									}
								%>
