...
<%@page import="model.entity.Level"%>
<%@page import="java.util.*"%>
<%
	PersistenceManager pm = PMF.get().getPersistenceManager();
	List<Level> res = (List<Level>) request.getAttribute("levels");
%>
<!DOCTYPE html>
<html lang="en">
			...
			<form action="/course/add" method="get">
				<fieldset>
					...
					<select name="levelId">
						...
						%>
					</select> <input type="text" name="name" placeholder="Nombre" required>
					<select name="dep">
					...
					</select> <input type="text" name="teacher" placeholder="Nombre del Docente"
						required> <input type="submit" value="Registrar">
				</fieldset>
			</form>
			<%
				} else {
