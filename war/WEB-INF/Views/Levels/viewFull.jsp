...
<%
	List<Level> res = (List<Level>) request.getAttribute("showFull");
%>
<!DOCTYPE html>
<html lang="en">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><%=t.getName()%></td>
									<td><%=t.getPension()%></td>
									<td><a href="/level/view?ID=<%=t.getId()%>">View</a><a
										href="/level/edit?ID=<%=t.getId()%>">Edit</a><a
										href="/level/delete?ID=<%=t.getId()%>">Delete</a></td>
								</tr>
								<%
									}
								%>
